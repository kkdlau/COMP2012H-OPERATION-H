...
class KeyboardManager : public QObject {
   ...
   private:
	/**
	 * @brief Hash map for storing key state, only keys used by combo are saved
	 * in this map.
	 */
   ...
   public:
	 ...
	 * the Keyboard Manager listens and emit signal if all combo keys are
	 * pressed.
	 *
   ...
   signals:
	 ...
	 * If the Keyboard Manager detects any combo, it emits this signal with
	 * combo to be tirggered.
	 *
